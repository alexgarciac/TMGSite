...
var gDocTable = new Array(
   ...
   new hrefList("slide0030.htm", 1, 2),
   new hrefList("slide0048.htm", 1, 3),
   new hrefList("slide0049.htm", 1, 4),
   new hrefList("slide0052.htm", 1, 5),
   new hrefList("slide0066.htm", 1, 6),
   new hrefList("slide0053.htm", 1, 7),
   new hrefList("slide0065.htm", 1, 8),
   new hrefList("slide0067.htm", 1, 9),
   new hrefList("slide0080.htm", 1, 10),
   new hrefList("slide0063.htm", 1, 11),
   new hrefList("slide0072.htm", 1, 12),
   new hrefList("slide0073.htm", 1, 13),
   new hrefList("slide0074.htm", 1, 14),
   new hrefList("slide0075.htm", 1, 15),
   new hrefList("slide0076.htm", 1, 16),
